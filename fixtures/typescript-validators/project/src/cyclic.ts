...
export function weakSetHas<V extends Record<any, any>>(
  weakset: WeakSet<V>,
  value: V
): boolean {
  try {
...
export function weakSetAdd<V extends Record<any, any>>(
  weakset: WeakSet<V>,
  value: V
): void {
  try {
...
export function weakSetDelete<V extends Record<any, any>>(
  weakset: WeakSet<V>,
  value: V
): void {
  try {
