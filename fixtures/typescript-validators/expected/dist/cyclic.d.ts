...
export declare function weakSetHas<V extends Record<any, any>>(weakset: WeakSet<V>, value: V): boolean;
export declare function weakSetAdd<V extends Record<any, any>>(weakset: WeakSet<V>, value: V): void;
export declare function weakSetDelete<V extends Record<any, any>>(weakset: WeakSet<V>, value: V): void;
