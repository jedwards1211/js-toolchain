# @jedwards1211/ts-react-toolchain
...
[![npm version](https://badge.fury.io/js/%40jedwards1211%2Fts-react-toolchain.svg)](https://badge.fury.io/js/%40jedwards1211%2Fts-react-toolchain)
...
- Test files are in `test`. You can override this by specifying options for mocha in `['@jedwards1211/ts-react-toolchain'].mochaArgs` in your `package.json`.
...
```sh
yarn add --dev @jedwards1211/ts-react-toolchain
...
The bootstrap script will modify your package.json, .gitignore, .circleci/config.yml and generate .babelrc.js, .eslintrc.js, and .prettierrc.js that are just proxies for the config in `@jedwards1211/ts-react-toolchain`.
